...
export function FirmDetailClient({ firmId }: { firmId: string }) {
  ...
  const [enabledApplications, setEnabledApplications] = useState<string[]>([]);
  ...
  const load = () => {
    fetch(`/api/admin/tax-professionals/${firmId}`)
      ...
      .then((data: Firm) => {
        ...
        setEnabledApplications(data.enabledApplications);
        setSubscriptionStartDate(toDateInput(data.subscriptionStartDate));
        setSubscriptionEndDate(toDateInput(data.subscriptionEndDate));
        setLoading(false);
      });
  };
    ...
    <div className="space-y-6">
      <Card className="p-6">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-sm font-semibold text-slate-900">Firm Profile & Subscription</h3>
        ...
        <form onSubmit={handleSaveFirm} className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-1">
              <FieldLabel>Subscription Start</FieldLabel>
              <input
                type="date"
                className={inputClass}
            ...
            <div className="space-y-1">
              <FieldLabel>Subscription End</FieldLabel>
              <input
                type="date"
                className={inputClass}
